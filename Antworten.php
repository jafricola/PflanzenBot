<?php
$plantFacts = [
    "„Fette Henne“ – das ist kein sehr dickes Huhn, sondern eine Pflanze. Die Fette Henne kann mit ihren dicken Blättern auch gut ohne Wasser auskommen.",

    "„Wolfsmilch“ diese Pflanze hat überhaupt nichts mit einem Wolf zu tun, aber dafür mit Milch. Bei dem „Milchsaft“ handelt es sich um giftigen Saft, der bei Berührung der Haut allergische Reaktionen hervorrufen kann.",

    "Es gitb einen „Leberwurstbaum“ - ja richtig gelesen! Es gibt tatsächlich einen Leberwurstbaum! Der ist in Afrika in der Umgebung rund um den Fluss Luangwa zu finden. Er ist dort für die Tiere lebensnotwendig, weil er Nahrung und Schutz bietet.",

    "Wenn Bäume in der Nähe von Straßenlaternen stehen, verlieren sie nicht so viele Blätter",

    "Aus Gänseblümchen kann man eine Salbe zur Minderung von Sommersprossen herstellen.",

    "Bestimmte Bambusarten können innerhalb von 24 Stunden 91 cm wachsen.",

    "Der „Küstenmammutbaum“ steht in Kalifornien und ist 115,92 m hoch. Er gilt als der höchste noch am lebende Baum der Welt.",
...
Die Erdnuss wächst unterirdisch, und dies hat der Frucht den Namen „Erdnuss“ eingebracht.",
    ...
    "Hyperion ist der Name eines Küstenmammutbaums (Sequoia sempervirens) in Kalifornien, der mit 115,92 m als der längste bekannte lebende Baum der Welt gilt.
Hyperion wurde am 25. August 2006 von den Naturforschern Chris Atkins und Michael Taylor entdeckt. Der Baum steht in einem abgelegenen Gebiet des Redwood-Nationalpark (Kalifornien). Er enthält schätzungsweise 530 Kubikmeter Holz und sein Alter wird auf 600 bis 800 Jahre geschätzt. ",
    ...
    "Es gibt viele Blumen, die wunderbar riechen. Wie die Schokoladen-Kosmee. Die bordeauxrote Blume hat den süßen und unverkennbaren Geruch von Zartbitterschokolade.",
    ...
    "Mimosa Punica, oder empfindliche Pflanze, wird ihre Blätter zusammenfalten, wenn sie berührt wird. Sie hat weißlich rosa flaumige Blumen, die wie kleine Pompons aussehen.",
...
$wateringPraises = [
    "Gute Arbeit!",
    "#Ehrengärtner!",
    "Du bist ein wahrer Pflanzenfreund!",
    "Ich bin stolz auf dich!",
    "Gut gemacht!",
    "Sauber!",
    "Nice gemacht vong Flüssigkeitszufuhr her!",
    "Richtig knorke!",
    "Die Firma dankt!",
    "Eine feuchte Pflanze ist eine glückliche Pflanze!",
    "Episch!",
    "Majestätisch!",
    ...
    "Nice!",
    "Sonnenlicht und Wasser gegen Sauerstoff - guter Tausch!"
];

function randomReplyFromArray($array)
{
